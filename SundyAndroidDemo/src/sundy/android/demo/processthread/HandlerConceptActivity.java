...
public class HandlerConceptActivity extends Activity {
	...
	class DelayHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			// TODO Auto-generated method stub
			super.handleMessage(msg);
			Log.i(CommonConstants.LOGCAT_TAG_NAME, "Start message: "+msg.getData().getString(HANDLER_KEY));
			try{Thread.sleep(5 * 1000);}catch(Exception e){}
			Log.i(CommonConstants.LOGCAT_TAG_NAME, "Finish message: "+msg.getData().getString(HANDLER_KEY));
		}		
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.buttonHandlerLab2_1).setOnClickListener(new OnClickListener(){
		...
		//Handler Lab2.2
		findViewById(R.id.buttonHandlerLab2_2).setOnClickListener(new OnClickListener(){
		...
		findViewById(R.id.buttonHandlerLab3_1).setOnClickListener(new OnClickListener(){
		...
		findViewById(R.id.buttonHandlerLab3_2).setOnClickListener(new OnClickListener(){
